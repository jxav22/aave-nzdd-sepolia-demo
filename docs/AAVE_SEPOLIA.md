...
Addresses for the official EURS market are resolved from the address book. The custom hackathon dNZD market is documented in [AAVE_HACKATHON_MNZD.md](./AAVE_HACKATHON_MNZD.md).
