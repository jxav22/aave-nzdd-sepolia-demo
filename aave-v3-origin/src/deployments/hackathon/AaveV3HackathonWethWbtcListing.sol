...
/**
 * @title AaveV3HackathonWethWbtcListing
 * @notice Lists wETH and wBTC on an existing hackathon market that already has dNZD.
 * @dev Hackathon / demo only — not for production. Parameters are illustrative.
 */
contract AaveV3HackathonWethWbtcListing is AaveV3Payload {
